...
public class PhoenixMigrationMediumTest extends MigrationTestCase {
    ...
    protected DataSource createDataSource(Properties customProperties) {
        return new DriverDataSource(Thread.currentThread().getContextClassLoader(), null, "jdbc:phoenix:localhost:", "", "");
    }
    ...
    public void trigger() throws Exception {
        flyway.setLocations("migration/dbsupport/phoenix/sql/trigger");
        flyway.migrate();
